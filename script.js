...
window.addEventListener('load', function(){
    ...
    class Background{
        ...
        restart(){
            this.x = 0;
            this.image.src = "kuribackground.png";
            //this.speed = 20;
        }
    }
    ...
    function displayStatusText(context){
        ...
        if(gameOver){
            if(score > 141){
                ...
                context.fillStyle = 'white';
                context.fillText('YOU WON, press Enter or swipe down to restart!', canvas.width / 2 + 2, 202);
                startButton.style.visibility = 'visible';
            } else {
                context.textAlign = 'center';
                context.fillStyle = 'black';
                context.fillText('YOU FAILED, press Enter or swipe down to restart!', canvas.width / 2, 200);
                context.fillStyle = 'white';
                context.fillText('YOU FAILED, press Enter or swipe down to restart!', canvas.width / 2 + 2, 202);
                startButton.style.visibility = 'visible';
            }
        }
    }
    ...
    ctx.fillStyle = 'black';
    ctx.fillText('MONTH BREAK SURVIVAL, press Enter or swipe down to start!', canvas.width / 2, 200);
    ctx.fillStyle = 'white';
    ctx.fillText('MONTH BREAK SURVIVAL, press Enter or swipe down to start!', canvas.width / 2 + 2, 202);
